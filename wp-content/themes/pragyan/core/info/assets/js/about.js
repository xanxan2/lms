jQuery(document).ready(function ($) {
    ...
    $('.pragyan-plugin-install-notice-wrap a.button').click(function (e) {
        e.preventDefault();

        $(this).addClass('updating-message');
        $(this).text(pragyan_about_obj.button_text);
        var params = {
            data: {
                action: pragyan_about_obj.starter_site_install_action,
                security: pragyan_about_obj.nonce,
                request: 1
            },
            ajax_url: ajaxurl,
            ...
            success_callback: function (response, extra_params) {
                ...
                if (typeof response.redirect != "undefined") {
                    ...
                    if ('' !== pragyan_about_obj.redirect) {
                        window.location.href = pragyan_about_obj.redirect;
                    }
                }
            }

        };
        pragyan_install_recommanded_plugins(params);
    });
    ...
    function pragyan_install_recommanded_plugins(params) {
