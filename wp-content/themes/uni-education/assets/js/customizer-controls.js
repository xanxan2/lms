...
jQuery( document ).ready(function($) {
    ...
    $(".uni-education-chosen-select").chosen({
        width: "100%"
    });
    ...
    $( document ).on( 'click', '.customize_multi_add_field', uni_education_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', uni_education_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', uni_education_customize_multi_remove_field )
    ...
    function uni_education_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            uni_education_customize_multi_write( $control );
    }

    function uni_education_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        uni_education_customize_multi_write( $control );
    }

    function uni_education_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function uni_education_customize_multi_write( $element) {
