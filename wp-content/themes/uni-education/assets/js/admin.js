jQuery(document).ready(function($) {
    ...
    $( document ).on( 'click', '.widget_multi_add_field', uni_education_widget_multi_add_field )
        .on( 'change', '.widget_multi_single_field', uni_education_widget_multi_single_field )
        .on( 'click', '.widget_multi_remove_field', uni_education_widget_multi_remove_field )

    function uni_education_set_multi_add_field() {
    ...
    uni_education_set_multi_add_field();
    
    function uni_education_widget_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            uni_education_widget_multi_write( $control );
    }

    function uni_education_widget_multi_single_field() {
        var $control = $( this ).parents( '.widget_multi_input' );
        uni_education_widget_multi_write( $control );
    }

    function uni_education_widget_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.widget_multi_input' );
        $this.parent().remove();
    ...
    function uni_education_widget_multi_write( $element) {
    ...
    $(document).on("click", ".uni-education-accordion", function (e) {
        e.preventDefault();
        var $button = $(this);

        $button.next('.uni-education-panel').slideToggle();
    ...
    function uni_education_contentTypeChange() {
    ...
    uni_education_contentTypeChange();

    function uni_education_widget_chosen() {
        $(".uni-education-widget-chosen-select").chosen({
            width: "100%"
        });
    }
    uni_education_widget_chosen();

    $(document).on('widget-updated widget-added', function(){

        // icon picker
        $('.uni-education-icon-picker').each( function() {
