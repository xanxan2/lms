...
class Uni_Education_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'uni_education';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'uni-education' ), $i ),
...
// Initialize.
$uni_education_footer_widgets = new Uni_Education_Footer_Widgets();
