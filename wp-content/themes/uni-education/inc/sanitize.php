...
if ( ! function_exists( 'uni_education_sanitize_select' ) ) :
	/**
	 ...
	 */
	function uni_education_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'uni_education_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function uni_education_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'uni_education_sanitize_page_post' ) ) :
	/**
	* Sanitizes page/post
	* @param  $input entered value
	* @return sanitized output
	*/
	function uni_education_sanitize_page_post( $input ) {
		// Ensure $input is an absolute integer.
...
if( ! function_exists( 'uni_education_sanitize_category' ) ) :
	/**
	 * Sanitizes dropdown single category
	 * @param  $input entered value
	 * @return sanitized output
	 */
	function uni_education_sanitize_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'uni_education_santize_allow_tags' ) ) :
	/**
	 ...
	 */
	function uni_education_santize_allow_tags( $input ) {
...
if ( ! function_exists( 'uni_education_sanitize_switch' ) ) :
	/**
	 * Sanitize data from custom Switch Control.
	 * @param  string $input 
	 * @return boolean    
	 */
	function uni_education_sanitize_switch( $input ) {
